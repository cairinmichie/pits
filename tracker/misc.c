...
int BuildSentence(unsigned char *TxLine, int Channel, struct TGPS *GPS)
{
	...
	int LoRaChannel;
	char TimeBuffer[12], ExtraFields1[20], ExtraFields2[20], ExtraFields3[20], ExtraFields4[64], ExtraFields5[32], ExtraFields6[32], *ExtraFields7, ExtraFields8[2];
	...
	// Add health of capsule and burn status.
	sprintf(ExtraFields8, ",%u,%u", GPS->Health, GPS->Burn);
